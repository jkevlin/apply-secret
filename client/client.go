...
var (
	...
	ErrSecretNameUnset = errors.New(`"secretName" is unset`)
...
// GetSecret gets a secret from the Kubernetes API.
func (c *Client) GetSecret(namespace, secretName string) (*Secret, error) {
